...
class hru {
  ...
  std::vector<double> const snow_param; // Add snow params
  ...
  std::vector<int> const temp_lnk_id; // Add
  std::vector<double> const temp_lnk_frc; // Add
...
public:
  ...
  double s_snow, s_liquid; // Add Snow Water Equivalent and liquid water
  double area;
  

  double q_sf_in, q_sz_in;
  double v_sf_rz, v_rz_uz, v_uz_sz;
  double precip, pet, aet, temp; // Add temp here
  ...
  hru(int const,
      ...
      std::vector<double> const,
      int const, std::vector<double> const,
      std::vector<double> const, // snow params
      std::vector<int> const, std::vector<double> const, // precip
      std::vector<int> const, std::vector<double> const, // pet
      std::vector<int> const, std::vector<double> const, // Temp
      std::vector<int> const, std::vector<double> const, // SF
      std::vector<int> const, std::vector<double> const // SZ
      );
